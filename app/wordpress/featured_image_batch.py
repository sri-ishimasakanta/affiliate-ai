...
SHAPE_SUMMARY = {
    ...
    14: "重なった 2 つの領域 (ベン図)",
    10: "曲線でつながる 3 つの丸いモジュール (流れ)",
    11: "段差のある 3 枚のプランカード (中にモジュールの鎖と時計)",
    16: "同じ窓のタイルが漏斗を通って 2 枚に絞られる",
    17: "5 列 × 4 行の比較の格子 (鍵と硬貨の印)",
    18: "左から右へ上る 4 段の階段 (上にデスクトップの窓)",
    19: "横に並ぶ 3 枚のパネル (会話 / 差し込むブロック / 文書の中の光)",
    21: "見出し (タブ) つきの文書と後ろの綴じ込み (点とチェックの行、隅に小さな盾)",
    22: "5 つの矢印の輪と中心の旗 (盾なし)",
}
